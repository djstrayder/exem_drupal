...
class __TwigTemplate_afb660cf9650a053b1ec4fe88254e5f5d7432fef0140225b24af40e949a96bac extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
            ...
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\flag\TwigExtension\FlagCount']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["site_name"] ?? null), 21, $this->source), "html", null, true));
            echo "</span>
  </a>
";
        }
    ...
    ";
            // line 26
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\flag\TwigExtension\FlagCount']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["site_slogan"] ?? null), 26, $this->source), "html", null, true));
            echo "
  </div>
";
        }
