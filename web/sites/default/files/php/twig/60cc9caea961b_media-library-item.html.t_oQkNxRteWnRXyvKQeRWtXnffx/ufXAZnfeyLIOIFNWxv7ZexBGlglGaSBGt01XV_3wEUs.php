...
class __TwigTemplate_a180d552b1f45aa2aedd5379c45312af1d63bbc8075d018026b2991672341eae extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  ";
        // line 27
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\flag\TwigExtension\FlagCount']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["content"] ?? null), 27, $this->source), "html", null, true));
        echo "
</div>
";
    }
